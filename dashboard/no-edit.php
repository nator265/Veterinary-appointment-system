...
<body>
            ...
            <div class="main-appointments-container" id="main-appointments-container">
                ...
                <a href="confirmpayment.php"><button class="confirm" id="bttn" style="border-radius: 5px; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-weight: 100;"> 
                    Confirm Payment <span id="floating"><?php
                        $select = "SELECT * FROM appointments WHERE bill_status = 'requesting_payment'";
                    ...
                    <div class="table">
                        <table>
                            ...
                            <?php 
                                ...
                                $retrieve = "SELECT doctors.fullname as name, appointments.animal, appointments.ap_type, appointments.ap_time, appointments.ap_date, appointments.ap_id, appointments.approved FROM doctors INNER JOIN appointments ON doctors.field = appointments.field where appointments.phone = '".$_SESSION['phone']."' and appointments.session_expiry = 'pending' and appointments.bill_status = 'Not paid' and approved = 'pending' ORDER BY appointments.ap_date ASC, appointments.ap_time ASC";
                ...
                <div class="alert-container" id="target">
                    <div class="alert" id="alert" style="opacity:1; display: flex;">
                        <div class="warning-container">
                            <div class="warning-header">
                                Unable to edit
                            </div>
                            <div class="subtext">
                                The appointment has been approved by the doctor therefore it cannot be edited. 
                            </div>
                            <form action="appointments.php" method="post">
                                <div class="buttonsection">
                                    <input type="button" class="edit" value="Okay" name="no" id="noclearance">
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        text: 'This appointment cannot be edited because it has been approved by the doctor',
        icon: 'success',
