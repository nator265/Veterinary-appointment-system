...
if(isset($_GET['confirm2'])){
    $_SESSION['confirmid2'] = $_GET['confirm2'];
                        ...
                        <table>
                            ...
                            <?php 
                                ...
                                while($row = $link->fetch_assoc()){
                                    ...
                                    <td style = "z-index: 1"><a href="confirmpayment2.php?confirm2=<?php $confirm = $_SESSION['confirmid2']; echo $confirm ?>" class="edit">Confirm</td>
                    ...
                    <div class="alert" id="alert">
                        <div class="warning-container">
                            ...
                            <form action="appointments.php" method="post">
                                    ...
                                    <a href="confirmpayment.php?confirm=<?php echo $_SESSION['confirmid2']; ?>">
