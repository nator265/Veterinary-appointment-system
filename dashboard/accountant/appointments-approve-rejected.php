                    ...
                    <div class="table" id="recents2">
                        <table>
                            ...
                            <?php
                                    ...
                                    $query = "SELECT * from appointments where field = '".$_SESSION['field3']."' and approved='rejected'";
                                        ...
                                        <td style="z-index:2"><a href="appointments-approve-rejected.php?approve=<?php echo $row['ap_id']?>"><button id="approve-button" value="<?php echo $ap_id ?>">Approve</button></a>
                                        </tr>
                        ...
                        <div class="warning-container">
                            ...
                            <form action="appointments.php" method="post">
                                    <div class="buttonsection">
                                        <a href="appointments-rejected.php?yes=<?php echo $_SESSION['thisap_id'] ?>">
