...
if(isset($_POST['submit'])){
    // getting the users phone from the database
    $getquery = "SELECT * from appointments where ap_id = '".$_SESSION['apid']."'";
    $querylink = mysqli_query($conn, $getquery);
    $fetchname = mysqli_fetch_assoc($querylink);
    $phone = $fetchname['phone'];
    ...
    checkSQL($conn, $rest);
     ...
     // to remove the appoitnment from the pending tab to the rejected tab.
    $removeqry = "UPDATE appointments SET approved = 'rejected' WHERE ap_id ='".$_SESSION['apid']."'";
        ...
        <div class="modal-container" id="modal-container">
            <div class="modal">
                <div class="form-container">
                    ...
                    <form action="appointments-reject3.php" method="POST">
                        ...
                        <div class="bttn-container">
                            ...
                            <input type="button" value="Cancel" name="submit"  id="reject-button">    
