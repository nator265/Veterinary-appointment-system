...
header('refresh: 2; url=prescription2.php');
...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO diagnosis (reported_signs, diagnosis, animal_id, animal_name, service_provided, prescribed_meds, dosage) VALUES ('$reportedSigns', '$diagnosis', '$animal_id', '$fetchedname', '$selectedservices', '$selectedmedicine', '$dosage')";
