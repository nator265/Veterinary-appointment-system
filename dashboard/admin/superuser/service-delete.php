...
if(isset($_GET['delete'])){
    $_SESSION['servicedelete'] = $_GET['delete'];
}
            ...
            <div class="main-appointments-container" id="main-appointments-container">
                 <div class="create">
                    <a href="add-service.php">
                        <button class="create" id="bttn" onclick="document.getElementById('modal-container').style.display='flex'" style="border-radius: 5px; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-weight: 100;"> Add a service </button>
                    </a>                
                </div>
                        ...
                        <table>
                            ...
                            <div class="approved-tab">
                                <?php
                                    ...
                                    $retrieve = "SELECT * FROM service_costs";
                                    ...
                                    while($row = $link->fetch_assoc()){
                                        ...
                                        <td><?php echo "K".number_format($row["service_cost"]) ?></td>
                                        <td style=" padding-top:12px; width:20px">
                                            <a href="edit-service.php?edit=<?php echo $row['cost_id']?>">
                                                <button class="action-buttons" id="approve-button" name="reject">Edit</button>
                                            </a>
                                        </td>
                                        <td style="text-align:left; padding-left:20px; padding-right:20px; width:20px"><a href="service-delete.php?delete=<?php echo $row['cost_id']?>">
                ...
                <div class="alert-container" id="target">
                    <div class="alert" id="alert">
                        <div class="warning-container">
                            ...
                            <div class="subtext">
                                Are you sure you want to remove this service from the records?
                            </div>
                            <form action="appointments.php" method="post">
                                    <div class="buttonsection">
                                    <a href="services.php?yes=<?php echo $_SESSION['servicedelete'] ?>">
