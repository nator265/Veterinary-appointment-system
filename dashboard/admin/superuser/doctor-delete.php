...
if(isset($_GET['delete'])){
    $_SESSION['doctordelete'] = $_GET['delete'];
}
?>
                            ...
                            <div class="approved-tab">
                                <?php
                                    ...
                                    while($row = $link->fetch_assoc()){
                                        ...
                                        <a href="doctor-delete.php?delete= <?php echo $row['phone']?>">
                                            <td><button class="action-buttons" id="reject-button" name="reject">Remove</a></button>
                                        </a>
                                        </tr>
                                    <?php } ?>
                            </div>    
                ...
                <div class="alert-container" id="target">
                    <div class="alert" id="alert">
                        <div class="warning-container">
                            ...
                            <div class="subtext">
                                Are you sure you want to remove the doctor from the records?
                            </div>
