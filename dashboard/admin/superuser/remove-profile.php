        ...
        <div class="column2">
            ...
            <div class="main-dashboard-container" id="main-dashboard-container">
                <div class="dashboard" id="dashboard" style="padding-left: 80px;"> 
                    <a href="remove-doctor.php" class="appointments-container" id="link2">
                        <div class="appointments" onclick="document.getElementById('add-modal').style.display='block'">
                            <div class="count-container">
                                ...
                                <div class="count">
                                    <img src="images/doctor.png" alt="remove doctor" height="150px" style='padding-top:20px; filter:saturate(80%)'>
                                </div>
                            </div>
                        </div>
                    </a>
                    <div class="notifications-container" id="link2">
                        <a href="remove-accountant.php">
                            <div class="notifications">
                                ...
                                <div class="count">
                                    <img src="images/accountant.png" alt="remove acccountant" height="150px" style='padding-top:20px; filter:saturate(80%)'>
                                </div>
                            </div>
                            </div>
                        </a>
