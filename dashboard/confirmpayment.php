...
if(isset($_GET['confirm'])){
    $confirmid = $_GET['confirm'];
    $update = "UPDATE appointments 
                SET bill_status = 'confirmed'
                WHERE ap_id = $confirmid";
    $linkselect = mysqli_query($conn, $update);
    header('location:appointments.php');
}
    ...
    <div class="shadow"></div>
        ...
        <div class="column2">
            <div class="greetings-container">
                <a href="appointments.php" style="text-decoration: underline;"> <--Previous page </a>
            </div>
                        ...
                        <table>
                            ...
                            <?php 
                                ...
                                while($row = $link->fetch_assoc()){
                                    ...
                                    $fetchprice = mysqli_fetch_assoc($linkselect);
                                    ...
                                    <td><?php echo "K".number_format($price) ?></td>
                                    <td style = "z-index: 1"><a href="confirmpayment2.php?confirm2=<?php echo $ap_id ?>" class="edit">Confirm</td>
                                    <td style = "z-index: 1"><a href="appointments-delete2.php?delete=<?php echo $ap_id ?>" class="cancel" id="clearance">Cancel</a></td>
                                    </tr>
                                <?php } 
                            ?>                                    
                        </table>
                    ...
                    <div class="alert" id="alert">
                        <div class="warning-container">
                            ...
                            <form action="appointments.php" method="post">
                                    ...
                                    <a href="appointments.php?confirm=<?php echo $ap_id ?>">
